...
class Boleto
{
    ...
    public function toArray(): array
    {
        ...
        foreach ($this as $key => $value) {
            ...
            } elseif ($value instanceof BeneficiarioFinal) {
                $array[$key] = $value->toArray();
            } elseif ($value instanceof MensagemInstrucao) {
                $array[$key] = $value->toArray();
            } elseif ($value instanceof CodigoCadastrarPIX) {
                $array[$key] = $value->value;
            } elseif ($value instanceof CodigoSituacao) {
                $array[$key] = $value->value;
            } elseif ($value instanceof RateioCredito) {
                // handled at collection level in CobrancaBancaria
                $array[$key] = $value->toArray();
            } else {
                $array[$key] = $value;
            }
