...
class Authenticator
{
    ...
    {
        $this->scope = ScopesCobrancaBancaria::SCOPES_COBRANCA_BANCARIA;
    ...
    private function generateToken(): string
    {
        try {
            ...
            $this->setRefreshTokenExpirationTime(time() + ($contentResponse->refresh_expires_in ?: 300));
            return $contentResponse->access_token;
        } catch (GuzzleException $e) {
            echo $e->getMessage();

            throw new AuthenticationException("Erro ao gerar token de acesso: " . $e->getMessage(), (int) $e->getCode(), $e);
        }
    }
