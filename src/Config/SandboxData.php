...
abstract class SandboxData
{
    ...
    const API_URI_COBRANCA = self::SUFIX_API_COBRANCA_BANCARIA . '/' . self::API_VERSION;
    const API_URI_MOVIMENTACOES = self::SUFIX_API_COBRANCA_BANCARIA . '/' . self::API_VERSION . '/boletos';
}